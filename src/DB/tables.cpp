...
"CREATE TABLE `t_log` ( \
  ...
  PRIMARY KEY (`log_id`) \
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='v3.0'; \
"},
{"t_notification",
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='v3.0'; \
"},
{"t_schedule",
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='v3.0'; \
"},
{"t_user_right",
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='v3.0'; \
"},
...
) ENGINE=InnoDB AUTO_INCREMENT=948 DEFAULT CHARSET=utf8mb4 COMMENT='v3.0'; \
"},
{"t_log_notifications",

...
class XPathFunctions
{
	public:
		...
		static Token *fnnot(XPathEval::func_context context,const std::vector<Token *> &args);
		...
		static Token *min(XPathEval::func_context context,const std::vector<Token *> &args);
		static Token *max(XPathEval::func_context context,const std::vector<Token *> &args);
		...
		static Token *string_join(XPathEval::func_context context,const std::vector<Token *> &args);

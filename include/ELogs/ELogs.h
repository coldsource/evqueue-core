...
class ELogs
{
	...
	public:
		static std::vector<std::map<std::string, std::string>> QueryLogs(std::map<std::string, std::string> filters, const std::string &groupby, unsigned int limit, unsigned int offset = 0);
